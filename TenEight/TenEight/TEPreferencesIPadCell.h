...
@protocol TEPreferencesIPadCellDelegate <NSObject>
- (void)didUpdateAttribute:(int)attributeID withValue:(NSString *)value;
@end

@interface TEPreferencesIPadCell : UITableViewCell
...
@property (nonatomic, weak) id <TEPreferencesIPadCellDelegate> delegate;
